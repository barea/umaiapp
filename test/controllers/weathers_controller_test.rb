...
class WeathersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weather" do
    assert_difference('Weather.count') do
      post weathers_url, params: { weather: { city_name: @weather.city_name, country: @weather.country, dt: @weather.dt, weather_info: @weather.weather_info } }
    end
  ...
  test "should update weather" do
    patch weather_url(@weather), params: { weather: { city_name: @weather.city_name, country: @weather.country, dt: @weather.dt, weather_info: @weather.weather_info } }
